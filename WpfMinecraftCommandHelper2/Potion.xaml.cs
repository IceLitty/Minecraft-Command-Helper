...
namespace WpfMinecraftCommandHelper2
{
    ...
    public partial class Potion : MetroWindow
    {
        ...
        // list for json creator
        private List<string> potionList = new List<string>();
        private List<string> potionListL = new List<string>();
        private List<string> potionListD = new List<string>();
        ...
        private void createBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            string format = "";
            if (tabPotionEffect1.IsChecked.Value) { potionList.Add("minecraft:speed"); potionListL.Add((tabPotionEffect1Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect1Time.Value.ToString()); format += "{Id:1,Amplifier:" + (tabPotionEffect1Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect1Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect1H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect2.IsChecked.Value) { potionList.Add("minecraft:slowness"); potionListL.Add((tabPotionEffect2Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect2Time.Value.ToString()); format += "{Id:2,Amplifier:" + (tabPotionEffect2Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect2Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect2H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect3.IsChecked.Value) { potionList.Add("minecraft:haste"); potionListL.Add((tabPotionEffect3Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect3Time.Value.ToString()); format += "{Id:3,Amplifier:" + (tabPotionEffect3Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect3Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect3H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect4.IsChecked.Value) { potionList.Add("minecraft:mining_fatigue"); potionListL.Add((tabPotionEffect4Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect4Time.Value.ToString()); format += "{Id:4,Amplifier:" + (tabPotionEffect4Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect4Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect4H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect5.IsChecked.Value) { potionList.Add("minecraft:strength"); potionListL.Add((tabPotionEffect5Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect5Time.Value.ToString()); format += "{Id:5,Amplifier:" + (tabPotionEffect5Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect5Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect5H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect6.IsChecked.Value) { potionList.Add("minecraft:instant_health"); potionListL.Add((tabPotionEffect6Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect6Time.Value.ToString()); format += "{Id:6,Amplifier:" + (tabPotionEffect6Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect6Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect6H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect7.IsChecked.Value) { potionList.Add("minecraft:instant_damage"); potionListL.Add((tabPotionEffect7Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect7Time.Value.ToString()); format += "{Id:7,Amplifier:" + (tabPotionEffect7Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect7Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect7H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect8.IsChecked.Value) { potionList.Add("minecraft:jump_boost"); potionListL.Add((tabPotionEffect8Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect8Time.Value.ToString()); format += "{Id:8,Amplifier:" + (tabPotionEffect8Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect8Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect8H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect9.IsChecked.Value) { potionList.Add("minecraft:nausea"); potionListL.Add((tabPotionEffect9Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect9Time.Value.ToString()); format += "{Id:9,Amplifier:" + (tabPotionEffect9Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect9Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect9H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect10.IsChecked.Value) { potionList.Add("minecraft:regeneration"); potionListL.Add((tabPotionEffect10Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect10Time.Value.ToString()); format += "{Id:10,Amplifier:" + (tabPotionEffect10Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect10Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect10H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect11.IsChecked.Value) { potionList.Add("minecraft:resistance"); potionListL.Add((tabPotionEffect11Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect11Time.Value.ToString()); format += "{Id:11,Amplifier:" + (tabPotionEffect11Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect11Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect11H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect12.IsChecked.Value) { potionList.Add("minecraft:fire_resistance"); potionListL.Add((tabPotionEffect12Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect12Time.Value.ToString()); format += "{Id:12,Amplifier:" + (tabPotionEffect12Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect12Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect12H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect13.IsChecked.Value) { potionList.Add("minecraft:water_breathing"); potionListL.Add((tabPotionEffect13Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect13Time.Value.ToString()); format += "{Id:13,Amplifier:" + (tabPotionEffect13Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect13Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect13H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect14.IsChecked.Value) { potionList.Add("minecraft:invisibility"); potionListL.Add((tabPotionEffect14Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect14Time.Value.ToString()); format += "{Id:14,Amplifier:" + (tabPotionEffect14Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect14Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect14H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect15.IsChecked.Value) { potionList.Add("minecraft:blindness"); potionListL.Add((tabPotionEffect15Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect15Time.Value.ToString()); format += "{Id:15,Amplifier:" + (tabPotionEffect15Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect15Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect15H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect16.IsChecked.Value) { potionList.Add("minecraft:night_vision"); potionListL.Add((tabPotionEffect16Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect16Time.Value.ToString()); format += "{Id:16,Amplifier:" + (tabPotionEffect16Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect16Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect16H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect17.IsChecked.Value) { potionList.Add("minecraft:hunger"); potionListL.Add((tabPotionEffect17Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect17Time.Value.ToString()); format += "{Id:17,Amplifier:" + (tabPotionEffect17Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect17Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect17H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect18.IsChecked.Value) { potionList.Add("minecraft:weakness"); potionListL.Add((tabPotionEffect18Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect18Time.Value.ToString()); format += "{Id:18,Amplifier:" + (tabPotionEffect18Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect18Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect18H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect19.IsChecked.Value) { potionList.Add("minecraft:poison"); potionListL.Add((tabPotionEffect19Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect19Time.Value.ToString()); format += "{Id:19,Amplifier:" + (tabPotionEffect19Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect19Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect19H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect20.IsChecked.Value) { potionList.Add("minecraft:wither"); potionListL.Add((tabPotionEffect20Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect20Time.Value.ToString()); format += "{Id:20,Amplifier:" + (tabPotionEffect20Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect20Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect20H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect21.IsChecked.Value) { potionList.Add("minecraft:health_boost"); potionListL.Add((tabPotionEffect21Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect21Time.Value.ToString()); format += "{Id:21,Amplifier:" + (tabPotionEffect21Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect21Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect21H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect22.IsChecked.Value) { potionList.Add("minecraft:absorption"); potionListL.Add((tabPotionEffect22Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect22Time.Value.ToString()); format += "{Id:22,Amplifier:" + (tabPotionEffect22Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect22Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect22H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect23.IsChecked.Value) { potionList.Add("minecraft:saturation"); potionListL.Add((tabPotionEffect23Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect23Time.Value.ToString()); format += "{Id:23,Amplifier:" + (tabPotionEffect23Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect23Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect23H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect24.IsChecked.Value) { potionList.Add("minecraft:glowing"); potionListL.Add((tabPotionEffect24Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect24Time.Value.ToString()); format += "{Id:24,Amplifier:" + (tabPotionEffect24Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect24Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect24H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect25.IsChecked.Value) { potionList.Add("minecraft:levitation"); potionListL.Add((tabPotionEffect25Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect25Time.Value.ToString()); format += "{Id:25,Amplifier:" + (tabPotionEffect25Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect25Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect25H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect26.IsChecked.Value) { potionList.Add("minecraft:luck"); potionListL.Add((tabPotionEffect26Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect26Time.Value.ToString()); format += "{Id:26,Amplifier:" + (tabPotionEffect26Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect26Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect26H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (tabPotionEffect27.IsChecked.Value) { potionList.Add("minecraft:unluck"); potionListL.Add((tabPotionEffect27Level.Value - 1).ToString()); potionListD.Add(tabPotionEffect27Time.Value.ToString()); format += "{Id:27,Amplifier:" + (tabPotionEffect27Level.Value - 1).ToString() + ",Duration:" + tabPotionEffect27Time.Value; if (tabPotionAllHideParticles.IsChecked.Value || tabPotionEffect27H.IsChecked.Value) { format += ",ShowParticles:0b},"; } else { format += "},"; } }
            if (format.Length >= 1)
            {
        ...
        {
            System.Diagnostics.Process.Start(System.IO.Directory.GetCurrentDirectory() + @"\docs\Potion.html");
        }
        ...
        {
            List<string> potionListL2 = new List<string>(potionListL);
            List<string> potionListD2 = new List<string>(potionListD);
            return new List<List<string>>(){ potionList, potionListL, potionListL2, potionListD, potionListD2 };
        }
        ...
        {
            string path = System.IO.Directory.GetCurrentDirectory() + @"\docs\Potion.html";
