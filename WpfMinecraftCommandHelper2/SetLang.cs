...
namespace WpfMinecraftCommandHelper2
{
    class SetLang
    {
        ...
        public List<string> SetSummon()
        {
            ...
            relanglist.Add(LangList[langID]["SummonAGetPotion"].ToString());
            ...
            relanglist.Add(LangList[langID]["SummonSHelpStr"].ToString());
            ...
            relanglist.Add(LangList[langID]["SummonVHelpStr"].ToString());
            ...
            relanglist.Add(LangList[langID]["SummonVHasAttribute"].ToString());
            relanglist.Add(LangList[langID]["SummonVHasEquipment"].ToString());
            relanglist.Add(LangList[langID]["SummonVHasPotion"].ToString());
            relanglist.Add(LangList[langID]["SummonVGetNBTBtn"].ToString());
            relanglist.Add(LangList[langID]["SummonVGetNBTBtn2"].ToString());
            relanglist.Add(LangList[langID]["SummonVCustomName"].ToString());
            relanglist.Add(LangList[langID]["SummonVPrePage"].ToString());
            relanglist.Add(LangList[langID]["SummonVNextPage"].ToString());
            relanglist.Add(LangList[langID]["SummonVInvulnerable"].ToString());
            relanglist.Add(LangList[langID]["SummonVNoAI"].ToString());
            relanglist.Add(LangList[langID]["SummonVSilent"].ToString());
            ...
            relanglist.Add(LangList[langID]["SummonOGetEgg"].ToString());
