...
namespace WpfMinecraftCommandHelper2
{
    ...
    public partial class Firework : MetroWindow
    {
        ...
        {
            System.Diagnostics.Process.Start(System.IO.Directory.GetCurrentDirectory() + @"\docs\Firework.html");
        }
        ...
        {
            string path = System.IO.Directory.GetCurrentDirectory() + @"\docs\Firework.html";
